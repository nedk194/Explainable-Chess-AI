...
# Piece-Square Tables (Black perspective)
'''
# Mapping piece type to their respective PST
...
PIECE_SQUARE_TABLES_WHITE = dict()
for key, val in PIECE_SQUARE_TABLES_BLACK.items():
    PIECE_SQUARE_TABLES_WHITE[key] = val[::-1]
'''
